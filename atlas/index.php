								...
								<div class="p-2" v-for="hb in listHepsiburada" v-if="item.id == hb.productsID">
									<div class="d-flex">
										...
										<div class="ml-auto">
											...
											<br>
											<span class="small-y text-danger" v-if="store_hb != hb.seller"><i class="bi bi-hand-thumbs-down-fill"></i> Buybox</span>	
											<span class="small-y text-success p-bold" v-if="store_hb == hb.seller"><i class="bi bi-hand-thumbs-up-fill"></i> Buybox</span>								 		
										</div>
									</div>
								...
								<div class="p-2" v-for="ty in listTrendyol" v-if="item.id == ty.productsID">
									<div class="d-flex">
										...
										<div class="ml-auto">
											...
											<br>
											<span class="small-y text-danger" v-if="store_ty != ty.seller"><i class="bi bi-hand-thumbs-down-fill"></i> Buybox</span>	
											<span class="small-y text-success p-bold" v-if="store_ty == ty.seller"><i class="bi bi-hand-thumbs-up-fill"></i> Buybox</span>							 		
										</div>
									</div>
								</div>
								...
								<div class="p-2" v-for="gg in listGittigidiyor" v-if="item.id == gg.productsID">
									<div class="d-flex">
										...
										<div class="ml-auto">
											...
											<br>
											<span class="small-y text-danger" v-if="store_gg != gg.seller"><i class="bi bi-hand-thumbs-down-fill"></i> Buybox</span>	
											<span class="small-y text-success p-bold" v-if="store_gg == gg.seller"><i class="bi bi-hand-thumbs-up-fill"></i> Buybox</span>								 		
										</div>
									</div>
